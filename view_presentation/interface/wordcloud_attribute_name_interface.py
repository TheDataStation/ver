...
class WordCloudAttributeNameInterface(interface):
    ...
    def rank_candidates (self, query, embedding_obj): 
        ...
        for df_iter in self.attr_dic.keys():
            dist=embedding_obj.get_distance(self.attr_dic[df_iter],query)
    ...
    def ask_question_gui(self, question, df_lst):
        ...
        print ("Does the required dataset contain this dataframe: ")
        ...
        return (['Yes, my data must contain this dataset', 'No, the data should not contain this dataset','Does not matter'],self.attribute_yesno,self.submit)
...
if __name__ == '__main__':
    ...
    attr_inf=WordCloudAttributeNameInterface("header content interface")
