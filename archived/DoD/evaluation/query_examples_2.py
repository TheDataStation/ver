...
output_base_path = '/home/cc/output_views_new/'
...
def query_examples(attrs, values, profile, output_path, gt_jp):
    ...
    for k, _ in candidate_columns.items():
        hits = results_hit[idx]
        visited = set()
        pruned = []
        ...
        for join_col1 in cols:
            ...
            for join_col2 in neighbors:
                ...
                if (tbl1, join_col1.field_name, tbl2, join_col2.field_name) == gt_jp:
                    gt_num = i
                mjp, io_time = join_two_tables(tbl1, join_col1.field_name, tbl2, join_col2.field_name)
